                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Here are your order details  <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
...
<p><b>Flat No / Building No.:</b> <?php echo $row['Flatnobuldngno']?></p>
 <p><b>Room no: </b> <?php echo $row['StreetName']?></p>
  <p><b>Hosel:</b> <?php echo $row['Area']?></p>
