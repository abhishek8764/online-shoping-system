...
if($query)
{
 ...
 echo "<script>alert('Sorry, Something went wrong. Please contact support if problem persists.');</script>";
}
}
...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="rsz_1supermarket.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Order Delivery</h1>
                    <h5 class="font-white space-xs">Easily Find and Order your favorite items from our catalogue</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-food.php">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="I would like to buy...."> </div>
                            </div>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose items you want</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4><span>2. </span>Fill in your Location </h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Room Delivery</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Popular Delicious items Here: <span class="primary-color">In All Hostels</span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular This Month In Your Hostels</h2>
                    <p class="lead">The easiest way to get your favourite items</p>
                </div>
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                        <div class="food-item-wrap">
                            ...
                            <div class="content">
                                ...
                                <div class="product-name" ><?php echo "available qty : ".$row['ItemQty']?></div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose the item you want</h3>
                                    <p>We've got you covered with our menu, containing all the essentials you'll need.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Fill in your location</h3>
                                <p>Just fill in your Room Number & Hostel and quit worrying about it!</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <h3>Room Delivery</h3>
<p>Get your order delivered to your hostel room! </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- end:Footer -->
    <b style="margin-left:35%;">AN INITIATIVE BY SMVDU STUDENTS, FOR SMVDU STUDENTS</b>
    </div>
    <!--/end:Site wrapper -->
