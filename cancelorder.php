...
if(isset($_POST['submit']) && $_SESSION['fosuid']!="")
  {
...
<?php } else { ?>
  <p style="color:red; font-size:20px;"> You can't cancel this order. Order has been picked up for delivery or has been delivered</p>
