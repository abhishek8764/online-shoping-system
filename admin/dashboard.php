...
<a class="text-muted text-uppercase m-b-20" href="notconfirmedyet.php" style="font-size: 20px"><strong>New Order</strong></a>
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Number of new incoming orders</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
?>
      <a class="text-muted text-uppercase m-b-20" href="confirmed-order.php" style="font-size: 20px"><strong>Confirmed Order</strong></a>                          
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Number of orders have been confirmed</small>
                            </div>
                        </div>
                    </div>
...
?>
<a class="text-muted text-uppercase m-b-20" href="foodbeingprepared.php" style="font-size: 20px"><strong>Being Packed</strong></a>
                               
                              
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $beigpre;?></h1>
<small>Items are being packed right now</small>
                            </div>
                        </div>
            </div>
...
?>
<a class="text-muted text-uppercase m-b-20" href="food-pickup.php" style="font-size: 20px"><strong>Orders Shipped</strong></a>
                                
                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $foodpickup;?></h1>
                                
                                <small>Number of orders are shipping</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
...
?>
<a class="text-muted text-uppercase m-b-20" href="food-delivered.php" style="font-size: 20px"><strong>Delivered</strong></a>

                            </div>
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $fooddel;?></h1>
                                <small>Total number of items Delivered</small>
                            </div>
                        </div>
                    </div>
...
<a class="text-muted text-uppercase m-b-20" href="canclled-order.php" style="font-size: 20px"><strong>Cancelled Order</strong></a>
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo $notconfirmedorder;?></h1>
                                <small>Number of orders have been cancelled</small>
                            </div>
                        </div>
                    </div>
